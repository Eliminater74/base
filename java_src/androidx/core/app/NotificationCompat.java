    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0200R.C0203id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0200R.C0203id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0200R.C0203id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0200R.C0203id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0200R.C0201color.notification_action_color_filter)));
            }
