    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = obtainAttributes(resources2, theme, attributeSet, C0200R.styleable.ColorStateListItem);
                int resourceId = obtainAttributes.getResourceId(C0200R.styleable.ColorStateListItem_android_color, -1);
                if (resourceId != -1 && !isColorInt(resources2, resourceId)) {
                    try {
                        ...
                        color = obtainAttributes.getColor(C0200R.styleable.ColorStateListItem_android_color, -65281);
                    }
                } else {
                    color = obtainAttributes.getColor(C0200R.styleable.ColorStateListItem_android_color, -65281);
                }
                float f2 = 1.0f;
                if (obtainAttributes.hasValue(C0200R.styleable.ColorStateListItem_android_alpha)) {
                    f2 = obtainAttributes.getFloat(C0200R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0200R.styleable.ColorStateListItem_alpha)) {
                    f2 = obtainAttributes.getFloat(C0200R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                if (BuildCompat.isAtLeastS() && obtainAttributes.hasValue(C0200R.styleable.ColorStateListItem_android_lStar)) {
                    f = obtainAttributes.getFloat(C0200R.styleable.ColorStateListItem_android_lStar, -1.0f);
                } else {
                    f = obtainAttributes.getFloat(C0200R.styleable.ColorStateListItem_lStar, -1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != C0200R.attr.alpha && attributeNameResource != C0200R.attr.lStar) {
                        int i5 = i3 + 1;
