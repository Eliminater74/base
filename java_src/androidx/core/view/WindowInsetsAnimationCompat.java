...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0200R.C0203id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0200R.C0203id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0200R.C0203id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
        ...
        static BoundsCompat computeAnimationBounds(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i) {
            ...
            return new BoundsCompat(Insets.m24of(Math.min(insets.left, insets2.left), Math.min(insets.top, insets2.top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m24of(Math.max(insets.left, insets2.left), Math.max(insets.top, insets2.top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(C0200R.C0203id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0200R.C0203id.tag_window_insets_animation_callback);
