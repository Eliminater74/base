...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0371Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0371Op(int i, Fragment fragment) {
            this.mCmd = i;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void addOp(C0371Op c0371Op) {
        this.mOps.add(c0371Op);
        c0371Op.mEnterAnim = this.mEnterAnim;
        c0371Op.mExitAnim = this.mExitAnim;
        c0371Op.mPopEnterAnim = this.mPopEnterAnim;
        c0371Op.mPopExitAnim = this.mPopExitAnim;
    }
