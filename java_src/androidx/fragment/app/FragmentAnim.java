...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z, boolean z2) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0315R.C0318id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0315R.C0318id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0315R.animator.fragment_open_enter : C0315R.animator.fragment_open_exit;
        } else if (i == 4099) {
            return z ? C0315R.animator.fragment_fade_enter : C0315R.animator.fragment_fade_exit;
        } else if (i != 8194) {
            return -1;
        } else {
            return z ? C0315R.animator.fragment_close_enter : C0315R.animator.fragment_close_exit;
        }
    }
