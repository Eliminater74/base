...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0315R.C0318id.fragment_container_view_tag);
    ...
    */
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0371Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C0315R.C0318id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0315R.C0318id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0315R.C0318id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
