    ...
    public static abstract class BuilderBase<B extends BuilderBase> {
        ...
        public B clickAction(long j) {
            if (j == -4) {
                ...
                this.mId = -6L;
                this.mTitle = this.mContext.getString(C0393R.string.lb_guidedaction_finish_title);
            } else if (j == -7) {
                this.mId = -7L;
                this.mTitle = this.mContext.getString(C0393R.string.lb_guidedaction_continue_title);
            } else if (j == -8) {
                this.mId = -8L;
                this.mTitle = this.mContext.getString(17039370);
            } else if (j == -9) {
