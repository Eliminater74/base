...
public class Picker extends FrameLayout {
    ...
    public Picker(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0393R.attr.pickerStyle);
    }
    ...
    public Picker(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0393R.styleable.lbPicker, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0393R.styleable.lbPicker, attributeSet, obtainStyledAttributes, i, 0);
        this.mPickerItemLayoutId = obtainStyledAttributes.getResourceId(C0393R.styleable.lbPicker_pickerItemLayout, C0393R.layout.lb_picker_item);
        this.mPickerItemTextViewId = obtainStyledAttributes.getResourceId(C0393R.styleable.lbPicker_pickerItemTextViewId, 0);
        ...
        this.mPickerView = (ViewGroup) ((ViewGroup) LayoutInflater.from(getContext()).inflate(C0393R.layout.lb_picker, (ViewGroup) this, true)).findViewById(C0393R.C0396id.picker);
    }
    ...
    public void setColumns(List<PickerColumn> list) {
        ...
        if (!TextUtils.isEmpty(this.mSeparators.get(0))) {
            TextView textView = (TextView) from.inflate(C0393R.layout.lb_picker_separator, this.mPickerView, false);
            textView.setText(this.mSeparators.get(0));
            this.mPickerView.addView(textView);
        }
        int i2 = 0;
        while (i2 < columnsCount) {
            VerticalGridView verticalGridView = (VerticalGridView) from.inflate(C0393R.layout.lb_picker_column, this.mPickerView, false);
            ...
            if (!TextUtils.isEmpty(this.mSeparators.get(i3))) {
                TextView textView2 = (TextView) from.inflate(C0393R.layout.lb_picker_separator, this.mPickerView, false);
    ...
    protected int getPickerItemHeightPixels() {
        return getContext().getResources().getDimensionPixelSize(C0393R.dimen.picker_item_height);
    }
