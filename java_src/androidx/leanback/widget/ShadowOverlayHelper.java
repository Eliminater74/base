...
public final class ShadowOverlayHelper {
    ...
    public void onViewCreated(View view) {
        ...
        if (!this.mNeedsShadow) {
            ...
            view.setTag(C0393R.C0396id.lb_shadow_impl, ShadowHelper.addDynamicShadow(view, this.mUnfocusedZ, this.mFocusedZ, this.mRoundedCornerRadius));
    ...
    void setupDynamicShadowZ(Options options, Context context) {
        if (options.getDynamicShadowUnfocusedZ() < 0.0f) {
            ...
            this.mFocusedZ = resources.getDimension(C0393R.dimen.lb_material_shadow_focused_z);
            this.mUnfocusedZ = resources.getDimension(C0393R.dimen.lb_material_shadow_normal_z);
            return;
        }
    ...
    void setupRoundedCornerRadius(Options options, Context context) {
        if (options.getRoundedCornerRadius() == 0) {
            this.mRoundedCornerRadius = context.getResources().getDimensionPixelSize(C0393R.dimen.lb_rounded_rect_corner_radius);
        } else {
    ...
    static Object getNoneWrapperDynamicShadowImpl(View view) {
        return view.getTag(C0393R.C0396id.lb_shadow_impl);
    }
