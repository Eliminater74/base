...
public class MediaNowPlayingView extends LinearLayout {
    ...
    public MediaNowPlayingView(Context context, AttributeSet attributeSet) {
        ...
        LayoutInflater.from(context).inflate(C0393R.layout.lb_playback_now_playing_bars, (ViewGroup) this, true);
        ImageView imageView = (ImageView) findViewById(C0393R.C0396id.bar1);
        this.mImage1 = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0393R.C0396id.bar2);
        this.mImage2 = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0393R.C0396id.bar3);
