...
public class RowHeaderPresenter extends Presenter {
    ...
    public RowHeaderPresenter() {
        this(C0393R.layout.lb_row_header);
    }
    ...
    public static class ViewHolder extends Presenter.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.mTitleView = (RowHeaderView) view.findViewById(C0393R.C0396id.row_header);
            this.mDescriptionView = (TextView) view.findViewById(C0393R.C0396id.row_header_description);
            initColors();
        }
        ...
        void initColors() {
            ...
            this.mUnselectAlpha = this.view.getResources().getFraction(C0393R.fraction.lb_browse_header_unselect_alpha, 1, 1);
        }
