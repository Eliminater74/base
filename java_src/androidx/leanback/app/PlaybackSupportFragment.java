...
public class PlaybackSupportFragment extends Fragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getContext().getTheme().resolveAttribute(C0393R.attr.playbackControlsAutoHideTimeout, typedValue, true);
        this.mAutohideTimerAfterPlayingInMs = typedValue.data;
        getContext().getTheme().resolveAttribute(C0393R.attr.playbackControlsAutoHideTickleTimeout, typedValue, true);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        RowsSupportFragment rowsSupportFragment = (RowsSupportFragment) getChildFragmentManager().findFragmentById(C0393R.C0396id.playback_controls_dock);
        this.mRowsSupportFragment = rowsSupportFragment;
        if (rowsSupportFragment == null) {
            this.mRowsSupportFragment = new RowsSupportFragment();
            getChildFragmentManager().beginTransaction().replace(C0393R.C0396id.playback_controls_dock, this.mRowsSupportFragment).commit();
        }
