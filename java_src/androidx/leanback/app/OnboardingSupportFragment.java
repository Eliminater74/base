...
public abstract class OnboardingSupportFragment extends Fragment {
    ...
    protected Animator onCreateDescriptionAnimator() {
        return AnimatorInflater.loadAnimator(getContext(), C0393R.animator.lb_onboarding_description_enter);
    }

    protected Animator onCreateTitleAnimator() {
        return AnimatorInflater.loadAnimator(getContext(), C0393R.animator.lb_onboarding_title_enter);
    }
