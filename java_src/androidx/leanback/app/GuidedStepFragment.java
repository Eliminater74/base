...
public class GuidedStepFragment extends Fragment implements GuidedActionAdapter.FocusListener {
    ...
    public void expandSubActions(GuidedAction guidedAction) {
        if (guidedAction.hasSubActions()) {
            expandAction(guidedAction, IS_FRAMEWORK_FRAGMENT);
        }
    }
    ...
    protected void onProvideFragmentTransitions() {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (uiStyle == 0) {
                ...
                TransitionHelper.exclude(createFadeAndShortSlide, C0393R.C0396id.guidedstep_background, (boolean) IS_FRAMEWORK_FRAGMENT);
                TransitionHelper.exclude(createFadeAndShortSlide, C0393R.C0396id.guidedactions_sub_list_background, (boolean) IS_FRAMEWORK_FRAGMENT);
            ...
            TransitionHelper.exclude(createFadeAndShortSlide4, C0393R.C0396id.guidedstep_background, (boolean) IS_FRAMEWORK_FRAGMENT);
            TransitionHelper.exclude(createFadeAndShortSlide4, C0393R.C0396id.guidedactions_sub_list_background, (boolean) IS_FRAMEWORK_FRAGMENT);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mAdapter = new GuidedActionAdapter(this.mActions, new GuidedActionAdapter.ClickListener() { // from class: androidx.leanback.app.GuidedStepFragment.2
            ...
            public void onGuidedActionClicked(GuidedAction guidedAction) {
                ...
                if (GuidedStepFragment.this.isExpanded()) {
                    ...
                    GuidedStepFragment.this.expandAction(guidedAction, GuidedStepFragment.IS_FRAMEWORK_FRAGMENT);
                }
            }
        ...
        }, this, this.mActionsStylist, IS_FRAMEWORK_FRAGMENT);
        ...
        if (this.mButtonActions.size() == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0393R.attr.guidedActionContentWidthWeightTwoPanels, typedValue, IS_FRAMEWORK_FRAGMENT)) {
    ...
    private void resolveTheme() {
        ...
        TypedValue typedValue = new TypedValue();
        boolean resolveAttribute = context.getTheme().resolveAttribute(i, typedValue, IS_FRAMEWORK_FRAGMENT);
        if (resolveAttribute) {
