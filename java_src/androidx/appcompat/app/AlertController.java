...
public class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0050R.styleable.AlertDialog, C0050R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0050R.C0053id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0050R.C0053id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0050R.C0053id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0050R.C0053id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0050R.C0053id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0050R.C0053id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0050R.C0053id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0050R.C0053id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C0050R.C0053id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                view = resolvePanel.findViewById(C0050R.C0053id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C0050R.C0053id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0050R.C0053id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0050R.C0053id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0050R.C0053id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0050R.C0053id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0050R.C0053id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0050R.C0053id.scrollView);
