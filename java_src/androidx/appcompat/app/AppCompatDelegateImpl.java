    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0050R.C0053id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C0050R.C0053id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0050R.C0053id.action_bar_activity_content);
    ...
    */
    public android.view.View createView(android.view.View r12, java.lang.String r13, android.content.Context r14, android.util.AttributeSet r15) {
        /*
            ...
            int[] r2 = androidx.appcompat.C0050R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r2)
            int r2 = androidx.appcompat.C0050R.styleable.AppCompatTheme_viewInflaterClass
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            color = ContextCompat.getColor(this.mContext, C0050R.C0051color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0050R.C0051color.abc_decor_view_status_guard);
        }
    ...
    public static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0050R.layout.abc_list_menu_item_layout);
