...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0050R.styleable.SearchView_layout, C0050R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0050R.C0053id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0050R.C0053id.search_edit_frame);
        View findViewById = findViewById(C0050R.C0053id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0050R.C0053id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0050R.C0053id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0050R.C0053id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0050R.C0053id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0050R.C0053id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0050R.C0053id.search_mag_icon);
        ...
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_searchIcon));
        ...
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_searchIcon));
