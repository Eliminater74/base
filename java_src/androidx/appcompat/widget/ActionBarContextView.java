...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) linearLayout.findViewById(C0050R.C0053id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0050R.C0053id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        View findViewById = this.mClose.findViewById(C0050R.C0053id.action_mode_close_button);
