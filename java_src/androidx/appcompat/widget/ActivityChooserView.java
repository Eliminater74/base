...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(getContext()).inflate(C0050R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0050R.C0053id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0050R.C0053id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0050R.C0053id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0050R.C0053id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0050R.C0053id.image);
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (view == null || view.getId() != 1) {
                        ...
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(C0050R.C0053id.title)).setText(ActivityChooserView.this.getContext().getString(C0050R.string.abc_activity_chooser_view_see_all));
                        return inflate;
                    }
                    return view;
                }
            ...
            if (view == null || view.getId() != C0050R.C0053id.list_item) {
            ...
            ((ImageView) view.findViewById(C0050R.C0053id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0050R.C0053id.title)).setText(resolveInfo.loadLabel(packageManager));
