...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        boolean z = true;
        if (getId() == C0050R.C0053id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0050R.C0053id.action_bar);
        this.mContextView = findViewById(C0050R.C0053id.action_context_bar);
    }
