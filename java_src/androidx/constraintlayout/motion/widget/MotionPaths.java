...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f29x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f30y = (int) ((f9 + (f11 * f)) - f15);
        ...
        this.mMode = 2;
        this.f29x = (int) (((motionPaths.f29x + (f16 * f10)) + (f18 * f11)) - f13);
        this.f30y = (int) (((motionPaths.f30y + (f10 * f17)) + (f11 * f)) - f15);
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f12 = (motionPaths2.f29x + (motionPaths2.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (motionPaths2.f30y + (motionPaths2.height / 2.0f)) - ((f11 / 2.0f) + f10);
        float f14 = f12 * f3;
