...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState transitionState) {
        ...
        int i = C01662.f27xabc7e4ac[transitionState2.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            Log.v(MotionLayout.TAG, str + append4.append(str5).toString() + " ---  " + constraintWidget);
        }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0189R.styleable.MotionLayout);
