...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f35mX + ", " + this.f36mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01781.f37x4c44d048[type.ordinal()];
        if (i2 == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C01781.f37x4c44d048[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
