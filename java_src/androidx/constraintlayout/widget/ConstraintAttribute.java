...
public class ConstraintAttribute {
    ...
    public int noOfInterpValues() {
        int i = C01871.f47x66adad53[this.mType.ordinal()];
        return (i == 1 || i == 2) ? 4 : 1;
    }

    public float getValueToInterpolate() {
        switch (C01871.f47x66adad53[this.mType.ordinal()]) {
            case 1:
            case 2:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            ...
            String str2 = "set" + str;
            try {
                switch (C01871.f47x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    public static void parse(Context context, XmlPullParser xmlPullParser, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        Object string;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0189R.styleable.CustomAttribute);
