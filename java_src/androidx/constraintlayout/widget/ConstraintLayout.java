...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                ...
                int i8 = C01881.f48xdde91696[dimensionBehaviour.ordinal()];
                if (i8 == 1) {
                ...
                int i9 = C01881.f48xdde91696[dimensionBehaviour2.ordinal()];
                if (i9 == 1) {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0189R.styleable.ConstraintLayout_Layout, i, i2);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
