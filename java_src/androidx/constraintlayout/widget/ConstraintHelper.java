...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0189R.styleable.ConstraintLayout_Layout);
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0189R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    ...
                    setIds(string);
                } else if (index == C0189R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0189R.C0192id.class.getField(str).getInt(null);
