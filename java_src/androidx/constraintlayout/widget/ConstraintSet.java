...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintLeft_creator, 82);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTop_creator, 82);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintRight_creator, 82);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBottom_creator, 82);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBaseline_creator, 82);
        ...
        mapToConstant.append(C0189R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0189R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintCircle, 61);
        ...
        mapToConstant.append(C0189R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0189R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0189R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0189R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0189R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0189R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0189R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0189R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0189R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0189R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0189R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0189R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0189R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constrainedHeight, 81);
    }
    ...
    public static class Layout {
        ...
        static {
            ...
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintLeft_creator, 76);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintTop_creator, 76);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintRight_creator, 76);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBottom_creator, 76);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBaseline_creator, 76);
            ...
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintCircle, 61);
            ...
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0189R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0189R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0189R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0189R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0189R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class Motion {
        ...
        void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m32clone());
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Constraint);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0189R.C0192id.class.getField(trim).getInt(null);
