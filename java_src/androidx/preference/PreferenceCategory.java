...
public class PreferenceCategory extends PreferenceGroup {
    ...
    public PreferenceCategory(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0809R.attr.preferenceCategoryStyle, 16842892));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (getContext().getTheme().resolveAttribute(C0809R.attr.colorAccent, typedValue, true) && (textView = (TextView) preferenceViewHolder.findViewById(16908310)) != null) {
                if (textView.getCurrentTextColor() != ContextCompat.getColor(getContext(), C0809R.C0810color.preference_fallback_accent_color)) {
                    return;
                }
