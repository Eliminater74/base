...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0974R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                String string = context.getString(C0974R.string.mtrl_picker_invalid_format);
                textInputLayout2.setError(string + "\n" + String.format(context.getString(C0974R.string.mtrl_picker_invalid_format_use), str) + "\n" + String.format(context.getString(C0974R.string.mtrl_picker_invalid_format_example), dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
