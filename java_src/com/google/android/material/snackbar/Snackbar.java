...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0974R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0974R.attr.snackbarButtonStyle, C0974R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C0974R.layout.mtrl_layout_snackbar_include : C0974R.layout.design_layout_snackbar_include, findSuitableParent, false);
