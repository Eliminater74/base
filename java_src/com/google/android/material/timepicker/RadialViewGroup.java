...
public class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0974R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0974R.styleable.RadialViewGroup, i, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C0974R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    protected void updateLayoutParams() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getId() != C0974R.C0977id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0974R.C0977id.circle_center, this.radius, f);
