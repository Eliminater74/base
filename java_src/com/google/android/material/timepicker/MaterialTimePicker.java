...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C0974R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0974R.attr.materialTimePickerStyle, C0974R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0974R.styleable.MaterialTimePicker, C0974R.attr.materialTimePickerStyle, C0974R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C0974R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C0974R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C0974R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C0974R.C0977id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C0974R.C0977id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C0974R.C0977id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C0974R.C0977id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C0974R.C0977id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.2
        ...
        ((Button) viewGroup2.findViewById(C0974R.C0977id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i != 0) {
            if (i == 1) {
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0974R.string.material_timepicker_clock_mode_description));
            }
            throw new IllegalArgumentException("no icon for mode: " + i);
        }
        return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0974R.string.material_timepicker_text_input_mode_description));
    }
    ...
    private int getThemeResId() {
        ...
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C0974R.attr.materialTimePickerTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
