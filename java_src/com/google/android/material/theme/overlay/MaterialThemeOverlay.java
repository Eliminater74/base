...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {16842752, C0974R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C0974R.attr.materialThemeOverlay};
