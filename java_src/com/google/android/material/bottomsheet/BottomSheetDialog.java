...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C0974R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0974R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C0974R.C0977id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C0974R.C0977id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C0974R.C0977id.coordinator);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(C0974R.C0977id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int i) {
        if (i == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0974R.attr.bottomSheetDialogTheme, typedValue, true)) {
                return typedValue.resourceId;
            }
            return C0974R.style.Theme_Design_Light_BottomSheetDialog;
        }
        return i;
    }
